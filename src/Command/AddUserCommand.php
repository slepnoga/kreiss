...
/**
 * php version 7.2.10
 *                     Copyright (c) 2019.  Andreis Vinogradovs aka slepnoga. All right is LTV {R}
 */
...
{
    // to make your command lazily loaded,
    // configure the $defaultName static property,
...
<info>Password</info>: '.str_repeat('*', mb_strlen($password)));
    ...
    protected function execute(InputInterface $input, OutputInterface $output): void
    {
        ...
        $this->validateUserData($username, $plainPassword, $email, 'slep');
